...
---
### Exercise 4
For this exercise, you are going to work with a .gtf file. First, take exons and genes and store them in separate .gtf files. Sort those files. Find out how they overlap. Redirect the output to a separate gtf file so it would be easier to analyze it.

>NOTE: Bedtools intersect works faster if you give sorted files as input.
