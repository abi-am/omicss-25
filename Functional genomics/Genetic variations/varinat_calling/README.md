...
During this practical session, you will perform alignment and variant calling on the **human genome**. A detailed, step-by-step workflow is provided in **variant_calling_pipeline.md**, and all required files are given to you.
